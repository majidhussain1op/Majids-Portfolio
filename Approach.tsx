    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card title="Development & Progress Update" icon={<AceternityIcon order="Phase 2" />}
          description="This month, our development team has made significant progress in enhancing the user interface and resolving key bugs. We successfully completed user testing for the new features, receiving valuable feedback that will guide our next steps. Currently, we are on track with our project timeline, and we anticipate completing the next phase"
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Development & Launch"
          ...
          description="This is where the magic happens Based on the approved design, I'll translate Everythink into functional code, building your website from ground up"
        >
          <CanvasRevealEffect
            animationSpeed={3}
